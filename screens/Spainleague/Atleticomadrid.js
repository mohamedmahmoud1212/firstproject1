...
export default  function Atleticomadrid  (){
    ...
    return (
        ...
        <Image source={require('../assets/imges/tatics/AtlitcoMadrid/Atletico_Madrid.png')} style={{width :56 , height : 74 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <Image source={require('../assets/imges/tatics/AtlitcoMadrid/cdc.png')} style={{width :87 , height : 87 , marginHorizontal : 290 , marginVertical : -10  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 106 }}> 2  -   0</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../assets/imges/tatics/AtlitcoMadrid/Atletico_Madrid.png')} style={{width :77 , height : 104 , marginHorizontal : 15 , marginVertical : 20 }}/>
            <Image source={require('../assets/imges/tatics/AtlitcoMadrid/ATlLMadridtatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}