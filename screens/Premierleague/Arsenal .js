...
export default  function Arsenal  (){
    ...
    return (
        ...
        <Image source={require('../../assets/tatics/Arsenal/Arsenal.png')} style={{width :58 , height : 69 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <Image source={require('../../assets/tatics/Arsenal/arsenalstaticas.jpg')} style={{width :424 , height : 328 , marginHorizontal : -15 , marginVertical: -10 }}/>
            <Image source={require('../../assets/tatics/Arsenal/Atatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </ScrollView>
    )}