    ...
    return (
        ...
        <Image source={require('../../assets/EnglishPremierLeague.png')} style={{width :76 , height : 76 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <TouchableOpacity onPress={()=> navigation.navigate('Manchestercity')}>
             <Image source={require('../../assets/manchCitey.png')} style={{width :120 , height : 120 , marginLeft : 20 , marginTop : 55}}/>
            ...
            <TouchableOpacity onPress={()=> navigation.navigate('Manchesterunited')}>
             <Image source={require('../../assets/manchUnited.png')} style={{width :148 , height : 148.06 , marginLeft : 5 , marginTop : 20}}/>
             <Text style={{fontSize:45 , fontWeight : "bold" , color : '#877DFA' , marginLeft : 140 , marginTop : -115 }}>Manchester</Text>
