...
export default  function Alahly  (){
    ...
    return (
        ...
        <Image source={require('../../assets/tatics/Alahaly/Alahaly.png')} style={{width :65 , height : 99 , marginLeft : 100 , marginTop : -70}}/>
            <Text style={{fontSize:20 , fontWeight : "bold" , color : '#877DFA' , marginLeft : 180 , marginTop : -50 }}>Alahly </Text>
            <View style= {{marginTop:50}}>
            <Image source={require('../../assets/tatics/Alahaly/Alahaly.png')} style={{width :82 , height : 127 , marginHorizontal : 300 , marginVertical : -20  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 106 }}> 1  -   2</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../assets/tatics/Alahaly/Al_Masry.png')} style={{width :88.44 , height : 89 , marginHorizontal : 15 , marginVertical : 20 }}/>
            <Image source={require('../../assets/tatics/Alahaly/Alahlystaticas.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical: -10 }}/>
            <Image source={require('../../assets/tatics/Alahaly/Alahalytatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}
