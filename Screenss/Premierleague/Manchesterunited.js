...
export default  function Manchesterunited  (){
    ...
    return (
        ...
        <Image source={require('../../assets/tatics/MCunited/manchUnited.png')} style={{width :66 , height : 66 , marginLeft : 100 , marginTop : -70}}/>
            ...
            <Image source={require('../../assets/tatics/MCunited/Tottenham.png')} style={{width :57 , height : 125.48 , marginHorizontal : 300 , marginVertical : -20  }}/>
            <Text style={{fontSize:55 , fontWeight : "bold" ,  marginVertical : -85 , marginHorizontal : 106 }}> 0  -   2</Text>
            <View style={{marginTop :'auto'}}>
            <Image source={require('../../assets/tatics/MCunited/manchUnited.png')} style={{width :92 , height : 90 , marginHorizontal : 15 , marginVertical : 20 }}/>
            <Image source={require('../../assets/tatics/MCunited/MUstaics.jpg')} style={{width :420 , height : 330 , marginHorizontal : -10 , marginVertical: -10 }}/>
            <Image source={require('../../assets/tatics/MCunited/MCtatics.jpg')} style={{width :400 , height : 578 , marginHorizontal : -0 , marginVertical: -10 }}/>
            </View>
            </View>
            </ScrollView>
    )}